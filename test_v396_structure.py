#!/usr/bin/env python3
"""Offline structure check for Arena Roblox Bridge 3.9.6.
...
def main() -> int:
    ...
    require(version["version"] == VERSION, "version.json is not 3.9.6")
    ...
    for marker in required_markers:
        require(marker in source, f"required 3.9.6 marker missing: {marker}")
    ...
    ast.parse(plugin_source(source))
    ...
    print("OK: 3.9.6 structure, Lua and XAML validation passed")
    return 0
